...
def init():
  ...
  try:
    ...
    queryForItemsInXml="select i.tid tid,i.title title,i.url url,IFNULL(p.imageUrl,'') posterPathUrl from imdb i left join imdbIdPosterPath p on i.tid = p.imdb_id;"
